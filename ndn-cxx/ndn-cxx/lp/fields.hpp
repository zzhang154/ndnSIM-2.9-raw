...
typedef FieldDecl<field_location_tags::Header,
                  uint64_t,
                  tlv::DpccpPathTag> DpccpPathTagField;
BOOST_CONCEPT_ASSERT((Field<DpccpPathTagField>));
...
typedef FieldDecl<field_location_tags::Header,
                  uint64_t,
                  tlv::DpccpQueueTag> DpccpQueueTagField;
BOOST_CONCEPT_ASSERT((Field<DpccpQueueTagField>));
...
typedef FieldDecl<field_location_tags::Header,
                  uint64_t,
                  tlv::DpccpPathDiscoveryTag> DpccpPathDiscoveryTagField;
BOOST_CONCEPT_ASSERT((Field<DpccpPathDiscoveryTagField>));
...
typedef boost::mpl::set<
  ...
  HopCountTagField,
  GeoTagField,
  DpccpPathTagField,                // add by z2h
  DpccpQueueTagField,               // add by z2h
  DpccpPathDiscoveryTagField,       // add by z2h
  CustomTagField
  > FieldSet;
